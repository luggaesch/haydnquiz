        ...
        <div style={{ display: "grid", justifyContent: "center", gridTemplateRows: "5fr 1fr", gridTemplateColumns: "1fr", gridGap: 50, width: "100vw", height: "100vh", color: "white", padding: 20 }}>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", width: "100%" }}>
                <div style={{ display: "flex", justifyContent: "flex-end", flexDirection: "column", alignItems: "center" }}>
                    {teamResults.length >= 2 && <div style={{ border: "3px dashed " + teamResults[1].team.color, width: "80%", fontSize: "3rem", display: "flex", justifyContent: "center", flexDirection: "column", alignItems: "center", background: "var(--question-item)", borderRadius: 12, padding: 20, boxShadow: "0 8px 16px rgba(0,0,0,0.19), 0 3px 3px rgba(0,0,0,0.23)" }}>
                ...
                <div style={{ width: "100%", display: "flex", justifyContent: "flex-end", flexDirection: "column", alignItems: "center" }}>
                    <div style={{ transform: "translateY(-25%)", border: "4px dashed " + teamResults[0].team.color, width: "100%", fontSize: "4rem", display: "flex", justifyContent: "center", flexDirection: "column", alignItems: "center", background: "var(--question-item)", borderRadius: 12, padding: 20, boxShadow: "0 8px 16px rgba(0,0,0,0.19), 0 3px 3px rgba(0,0,0,0.23)" }}>
                ...
                <div style={{ display: "flex", justifyContent: "flex-end", flexDirection: "column", alignItems: "center" }}>
                    {teamResults.length >= 3 && <div style={{ border: "3px dashed " + teamResults[2].team.color, width: "80%", fontSize: "3rem", display: "flex", justifyContent: "center", flexDirection: "column", alignItems: "center", background: "var(--question-item)", borderRadius: 12, padding: 20, boxShadow: "0 8px 16px rgba(0,0,0,0.19), 0 3px 3px rgba(0,0,0,0.23)" }}>
            ...
            <div style={{ display: "flex", flexDirection: "row", justifyContent: "center", alignItems: "center", width: "100%", gap: 30 }}>
                {teamResults.slice(3).map((result, index) => (
                    <div key={index} style={{ borderRadius: 12, border: "3px dashed " + result.team.color, display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", fontSize: "3em", width: 300, height: 300, background: "#282828", boxShadow: "0 8px 16px rgba(0,0,0,0.19), 0 3px 3px rgba(0,0,0,0.23)" }}>
