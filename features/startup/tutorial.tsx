        ...
        <div style={{ width: "100vw", height: "100vh", overflowY: "scroll", overflowX: "hidden" }}>
            <div style={{ width: "100vw", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", padding: "40px 20px", gap: 30, overflowY: "scroll" }}>
                ...
                {sections.map((section, index) => {
                    ...
                    return (
                        <div key={index} style={{ zIndex: 10, gridTemplateRows: "1fr", padding: 30, width: "90%", color: "white", backgroundColor: "#282828", boxShadow: "var(--elevation-shadow)", height: "80vh", borderRadius: 8, display: "grid", gridTemplateColumns: index % 2 === 0 ? "1fr 5fr" : "5fr 1fr" }}>
                ...
                <div onClick={onSubmit} style={{ zIndex: 5, width: "50%", backgroundColor: "var(--accent)", borderRadius: 20, textAlign: "center", fontSize: 40, padding: 20, cursor: "pointer" }}>
                    Weiter
                </div>
            </div>
        </div>
